...
<h3 class="center">商品削除</h3>
<div class="center">
<form method="post" name="update" action="../jp.co.aforce.servlet/admindelete2servlet" onsubmit="return beforeSubmit()">
	<input type="hidden" name="img" value="${itemBean.img}">
	<img src="${itemBean.img}" style="width:360px; height:260px; border-radius:10px;" ><br>
	<p>商品名：<input type="text" name="updatename" size="30" value="${itemBean.itemName}" disabled><br></p>
	<p>値段（税込み）：<input type="text" name="updateprice" size="6" value="${itemBean.price}" disabled>円<br></p>
	...
	<button class="widewhitebutton" type="submit">削除</button></p>
</form>
</div>
