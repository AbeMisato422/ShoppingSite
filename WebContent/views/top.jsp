...
<% if(session.getAttribute("userBean")==null){
	request.getRequestDispatcher("../jp.co.aforce.servlet/unlogintopservlet").forward(request, response);
} %>
...
<!-- ナビメニュー -->
<nav id="nav">
<img src="../img/batsu.png" style="width:9%; height:5%; padding-top:110px; padding-left:35px;">
  <ul>
  <li><h4>商品検索</h4></li>
  	<li><h4>　カテゴリ</h4></li>
...
<form method="post" name="cart" action="http://localhost:8080/ShoppingSite/jp.co.aforce.servlet/cartaddservlet">
...
<tr>
	...
	<td><form method="post" name="id" action="../jp.co.aforce.servlet/cartaddservlet">
